...
exports.ProxyStateTree = exports.MutationTree = exports.TrackStateTree = exports.PATH = exports.VALUE = exports.PROXY_TREE = exports.IS_PROXY = void 0;
const tslib_1 = require("tslib");
const MutationTree_1 = require("./MutationTree");
Object.defineProperty(exports, "MutationTree", { enumerable: true, get: function () { return MutationTree_1.MutationTree; } });
const Proxyfier_1 = require("./Proxyfier");
Object.defineProperty(exports, "IS_PROXY", { enumerable: true, get: function () { return Proxyfier_1.IS_PROXY; } });
Object.defineProperty(exports, "PATH", { enumerable: true, get: function () { return Proxyfier_1.PATH; } });
Object.defineProperty(exports, "PROXY_TREE", { enumerable: true, get: function () { return Proxyfier_1.PROXY_TREE; } });
Object.defineProperty(exports, "VALUE", { enumerable: true, get: function () { return Proxyfier_1.VALUE; } });
const TrackStateTree_1 = require("./TrackStateTree");
Object.defineProperty(exports, "TrackStateTree", { enumerable: true, get: function () { return TrackStateTree_1.TrackStateTree; } });
...
class ProxyStateTree {
    ...
    */
    createTrackStateProxifier() {
        const trackStateTree = new TrackStateTree_1.TrackStateTree(this);
        this.proxifier = trackStateTree.proxifier = new Proxyfier_1.Proxifier(trackStateTree);
        this.state = trackStateTree.state = this.proxifier.proxify(this.sourceState, '');
    }
    getMutationTree() {
        if (!this.options.devmode) {
            return (this.mutationTree =
                this.mutationTree || new MutationTree_1.MutationTree(this, this.proxifier));
        }
    ...
    getTrackStateTreeWithProxifier() {
        ...
        tree.proxifier = new Proxyfier_1.Proxifier(tree);
    ...
    rescope(value, tree) {
        return value && value[Proxyfier_1.IS_PROXY]
            ? tree.proxifier.proxify(value[Proxyfier_1.VALUE], value[Proxyfier_1.PATH])
            : value;
    }
...
exports.ProxyStateTree = ProxyStateTree;
