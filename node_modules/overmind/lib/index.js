...
class Overmind {
    constructor(configuration, options = {}, mode = {
        ...
        if ((!process.env.NODE_ENV || process.env.NODE_ENV === devEnv) &&
        ...
        */
        ...
        /*
          ...
          the eventHub
        */
        const proxyStateTree = this.createProxyStateTree(configuration, eventHub, mode.mode === utils_1.MODE_TEST || process.env.NODE_ENV === devEnv);
